...
class Tutorial(models.Model):
    ...
    creator = models.CharField(
        verbose_name="creator/copyright", null=True, max_length=254
    )
    email_contact = models.EmailField(
        verbose_name="email contact", max_length=255, null=True
    )
    github_contact = models.CharField(
        verbose_name="github username/handle", max_length=50, blank=True
    )
