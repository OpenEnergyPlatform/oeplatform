...
- The recaptcha container was increased as 7 characters are used on the
  [(#2063)](https://github.com/OpenEnergyPlatform/oeplatform/pull/2063)

- Fix the broken YASGUI javaScript package integration in the
  OEKG-SPARQLl-Query-UI
  [(#2063)](https://github.com/OpenEnergyPlatform/oeplatform/pull/2063)
