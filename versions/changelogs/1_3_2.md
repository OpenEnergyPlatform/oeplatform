...
- On the data preview page in the Meta Information section, add a dropdown
  button to either download the oemetadata.json file or view the oemetadata api
  page for the specific table
  [(#2051)](https://github.com/OpenEnergyPlatform/oeplatform/pull/2051)
