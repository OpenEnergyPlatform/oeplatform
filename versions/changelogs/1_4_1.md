...
- Fix a bug in the scenario bundle access management which prevents other users
  but the owner to hold edit permissions to scenario bundles
  [(#2106)](https://github.com/OpenEnergyPlatform/oeplatform/pull/2106)
