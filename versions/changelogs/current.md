...
- Update schema.json for metaEdit module and update omi version in requirements.txt. This change makes the metadata edit / download results more robust. [(PR#)](https://github.com/OpenEnergyPlatform/oeplatform/pull/)
