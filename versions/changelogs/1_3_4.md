...
- Add a new REST-API which searches the postgresql information schema and
  returns all or table specific information on the disk-size of the data
  [(#2075)](https://github.com/OpenEnergyPlatform/oeplatform/pull/2075)
