    ...
    if Duplicate_study_factsheet == True:  # noqa
        ...
        for item in _scenarios:
            if item["acronym"] != "":
                ...
                bundle.add((study_URI, OEO.BFO_0000051, scenario_URI))
                bundle.add(
                    (
                        scenario_URI,
                        DC.acronym,
        ...
        for item in _models:
            ...
            bundle.add((study_URI, OEO.BFO_0000051, model_URI))
        ...
        for item in _frameworks:
            ...
            bundle.add((study_URI, OEO.BFO_0000051, framework_URI))
    ...
    if Duplicate_study_factsheet == False:  # noqa
        ...
        for item in _scenarios:
            if item["acronym"] != "":
                ...
                new_bundle.add((study_URI, OEO.BFO_0000051, scenario_URI))
        ...
        for item in _models:
            ...
            new_bundle.add((study_URI, OEO.BFO_0000051, model_URI))
        ...
        for item in _frameworks:
            ...
            new_bundle.add((study_URI, OEO.BFO_0000051, framework_URI))
...
def factsheet_by_id(request, *args, **kwargs):
    ...
    factsheet["sectors"] = []
    for s, p, o in oekg.triples((study_URI, OEO.OEO_00020439, None)):
        label = oeo.value(o, RDFS.label)
        class_iri = o
        if label != None:  # noqa
            factsheet["sectors"].append(
                {"value": label, "label": label, "class": class_iri, "id": class_iri}
            )
    ...
    for _, _, o in oekg.triples((study_URI, OEO.BFO_0000051, None)):
...
def get_scenarios(request, *args, **kwargs):
    ...
    for s, p, o in oekg.triples((None, RDF.type, OEO.OEO_00000365)):
        ...
        if str(scenario_uid) in scenarios_uid:
            ...
            for s1, p1, o1 in oekg.triples((None, OEO.BFO_0000051, s)):
