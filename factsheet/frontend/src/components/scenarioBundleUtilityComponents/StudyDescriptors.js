...
export const StudyKeywords = [
    ...
    ['total net electricity generation', 'https://openenergy-platform.org/ontology/oeo/OEO_00240013', 'Net electricity generation is a process attribute that equals to gross electricity generation minus the consumption of power stations auxiliary services.'],
    ['peak electricity generation', 'https://github.com/OpenEnergyPlatform/ontology/issues/1837', ''],
    ['study report due to legal obligation', 'https://openenergy-platform.org/ontology/oeo/OEO_00020373', 'A study report due to legal obligation is a study report that is created because of a legal obligation.'],
