...
echo "  2. Build the application image:"
echo "       podman build -t localhost/oeplatform:latest -f podman/Dockerfile ."
echo "       podman build -t localhost/oep-ontop:latest -f docker/Dockerfile.ontop docker/"
