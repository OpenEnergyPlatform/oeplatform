...
from login.views import (
    ...
    token_reset_view,
    user_group_delete_view,
    user_group_leave_view,
    user_redirect_view,
)
...
urlpatterns = [
    ...
    re_path(
        ...
        UserGroupsView.as_view(group_type="organization"),
        name="organizations",
    ),
    re_path(
        r"^profile/(?P<user_id>[\d]+)/projects$",
        UserGroupsView.as_view(group_type="project"),
        name="projects",
    ),
    re_path(
