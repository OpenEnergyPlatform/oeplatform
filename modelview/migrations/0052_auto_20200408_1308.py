...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='basicfactsheet',
            name='support',
            field=models.BooleanField(default=False, help_text='What kind of support is available? Please check the boxes!', verbose_name='Support / Community / Forum'),
        ),
        migrations.AlterField(
            model_name='basicfactsheet',
            name='user_documentation',
            field=models.CharField(help_text='Is an user documentation available for the framework? Please insert the link', max_length=200, null=True, verbose_name='Link to User Documentation'),
        ),
        migrations.AlterField(
            model_name='energyframework',
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(default=False, help_text='Is an installation guide provided for the framework (e.g. as part of the documentation)? Please provide a link', verbose_name='Installation guide'),
        ),
        migrations.AlterField(
            model_name='energyframework',
            name='link_to_code_documentation',
            field=models.CharField(help_text='Is a code/API documentation availaibe for the framework? Please insert the link!', max_length=200, null=True, verbose_name='Link to code documentation'),
        ),
        migrations.AlterField(
            model_name='energyframework',
            name='source_code_availability',
            field=models.CharField(help_text='What is the link to the source code?', max_length=200, null=True, verbose_name='Code availability'),
        ),
    ]
