...
class Energyscenario(models.Model):
    ...
    cost_development_learning_curves = BooleanField(verbose_name="learning curves") # noqa
    ...
    potential_solar_electric_economical = BooleanField(verbose_name="economical") # noqa
    potential_solar_electric_ecological = BooleanField(verbose_name="ecological") # noqa
    ...
    potential_solar_thermal_economical = BooleanField(verbose_name="economical") # noqa
    potential_solar_thermal_ecological = BooleanField(verbose_name="ecological") # noqa
    ...
    further_assumptions_for_postprocessing_text = CharField(max_length=1000, null=True) # noqa
