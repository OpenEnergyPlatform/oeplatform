...
"study_descriptors" : [
    "life cycle analysis", "(changes in) demand", "degree of electrifiaction", "Reallabor", "regionalisation", "peak electricity generation" 
    ],
...
"models" : [
        ...
        {   
            "id ": "Balmorel ", "name ": "Balmorel "},
        { 
            "id ": "National Electricity Market Optimiser ", "name ": "National Electricity Market Optimiser "
        },
        { 
            "id ": "urbs Bavaria ", "name ": "urbs Bavaria "
        }
    ]
"frameworks" : [
    { 
...
sparql_query = {'query': """SELECT ?s ?p ?o
                            WHERE {
                              ?s ?p ?o
                            }""" }
